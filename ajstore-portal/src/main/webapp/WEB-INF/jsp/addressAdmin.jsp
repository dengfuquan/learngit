	...
	<div id="container" class="clearfix">
		...
		<div class="rightsidebar_box rt">
			...
			<div class="rs_content">
				<form method="post" action="/address/insert.html">
					<!--收货人姓名-->
					...
					<div data-toggle="distpicker" class="address_content">
						<span class="red">*</span><span class="kuan">
							省&nbsp;&nbsp;份：</span> <select data-province="---- 选择省 ----"
							name="receiverState" id="receiverState"></select> 城市：<select
							data-city="---- 选择市 ----" name="receiverCity" id="receiverCity"></select>
						区/县：<select data-district="---- 选择区 ----" name="receiverDistrict"
				...
				<div class="address_information_manage">
					...
					<c:forEach items="${ajiaShippingList}" var="ajiaShipping">
						<div class="aim_content_one aim_active">
							<span class="dzmc dzmc_active">办公室</span> <span
								class="dzxm dzxm_normal">${ajiaShipping.receiverName}</span> <span
								class="dzxq dzxq_normal">${ajiaShipping.receiverAddress}</span>
							<span class="lxdh lxdh_normal">${ajiaShipping.receiverPhone}</span>
							<span class="operation operation_normal"> <span
								class="aco_change">修改</span>|<span id="${ajiaShipping.addId}" class="aco_delete">删除</span>
							</span> <span data-userid="14" data-addressId="${ajiaShipping.addId}" class="swmr swmr_normal">${ajiaShipping.isDefault?"":"设为默认"}</span>
						</div>
					</c:forEach>
