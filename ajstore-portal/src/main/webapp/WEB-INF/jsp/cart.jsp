					...
					<div id="content_box">
						...
						<c:forEach items="${voList}" var="vo">
							<div class="imfor">
								...
								<div class="pudc">
									<div class="pudc_information" id="${vo.ajiaItem.id}">
										<img width=50 height=50 src="${vo.ajiaItem.image}" class="lf" />
										...
										<c:forEach items="${vo.paramsList}" var="itemParam">
											<p class="col lf">
												<span>${itemParam.key }：</span> <span class="color_des">${itemParam.values.get(0) }
													<input type="hidden" name="" value="">
												</span>
											</p>
										</c:forEach>
								...
								<div class="pices">
									...
									<p class="pices_information">
										<b>￥</b><span>${vo.ajiaItem.price } <input
											type="hidden" name="" value=""></span>
									</p>
								</div>
								<div class="num">
									<span class="reduc">&nbsp;-&nbsp;</span><input type="text"
										value="${vo.ajiaCartItem.num }"><span class="add">&nbsp;+&nbsp;</span>
								</div>
								<div class="totle">
									<span>￥</span> <span class="totle_information">${vo.ajiaCartItem.num*vo.ajiaItem.price}</span>
								</div>
								<div class="del">
									<!-- <div>
                        ...
                        -->
									<a href="/cart/deleteById.html?itemId=${vo.ajiaItem.id}"
										class="del_d">删除</a>
								</div>
							</div>
						</c:forEach>
...
if (errorInfo)
    ...
    $("#go-buy").click(function(){
        //window.location.href="/cart/orderConfirm.html";
    })
</script>
</body>
</html>