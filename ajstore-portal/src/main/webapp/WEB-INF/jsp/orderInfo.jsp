...
<div id="container">
        ...
        <div class="container_nav">
            首页&gt;订单管理&gt;订单<span>${ajiaOrderVo.ajiaOrder.orderId}</span>
        </div>
        <div class="orderInfo_icon">
            <p>订单<span class="order-num">${ajiaOrderVo.ajiaOrder.orderId}</span>&nbsp;&nbsp;&nbsp;当前状态：<span class="state">
      <c:if test="${ajiaOrderVo.ajiaOrder.status==1}">
      待付款
      </c:if> 
      <c:if test="${ajiaOrderVo.ajiaOrder.status==2}">
      已付款
      </c:if>      
          <c:if test="${ajiaOrderVo.ajiaOrder.status==3}">
      未发货
      </c:if> 
      <c:if test="${ajiaOrderVo.ajiaOrder.status==4}">
      已经发货
      </c:if><c:if test="${ajiaOrderVo.ajiaOrder.status==5}">
      待收货
      </c:if> 
      <c:if test="${ajiaOrderVo.ajiaOrder.status==6}">
      待评价
      </c:if><c:if test="${ajiaOrderVo.ajiaOrder.status==7}">
      交易成功
      </c:if> 
      ...
      订单取消
        ...
        <div id="orderStatusChart">
              <dl>
                  <dt>
                  <c:if test="${ajiaOrderVo.ajiaOrder.status==8}">
                                      <img src="../images/orderinfo/orderinfo_img1.png" alt=""/></dt>
                  
                  </c:if>
                   <c:if test="${ajiaOrderVo.ajiaOrder.status>=1 && ajiaOrderVo.ajiaOrder.status<8}">
                                      <img src="../images/orderinfo/orderinfo_img1_2.png" alt=""/></dt>
                  
                  <dd>
                      <p>提交订单</p>
                      <span><fmt:formatDate pattern="yyyy-MM-dd hh:mm" value="${ajiaOrderVo.ajiaOrder.createTime}" /></span>
                  </dd>
                  </c:if>
              ...
              <dl>
                <dt class="point">
                <c:if test="${ajiaOrderVo.ajiaOrder.status<2 || ajiaOrderVo.ajiaOrder.status==8}">
                <img src="../images/orderinfo/orderinfo_img6.png" alt=""/></dt>
                </c:if>
                <c:if test="${ajiaOrderVo.ajiaOrder.status>=2 && ajiaOrderVo.ajiaOrder.status<8}">
                <img src="../images/orderinfo/orderinfo_img6_2.png" alt=""/></dt>
                </c:if>
              </dl>
              ...
              <dl>
                  <dt>
                  <c:if test="${ajiaOrderVo.ajiaOrder.status<2 || ajiaOrderVo.ajiaOrder.status==8}">
                                 <img src="../images/orderinfo/orderinfo_img2.png" alt=""/>
              ...
              <dl>
                <dt class="point">
                <c:if test="${ajiaOrderVo.ajiaOrder.status<4 || ajiaOrderVo.ajiaOrder.status==8 }">
                <img src="../images/orderinfo/orderinfo_img6.png" alt=""/></dt>
                </c:if>
                <c:if test="${ajiaOrderVo.ajiaOrder.status>=4 && ajiaOrderVo.ajiaOrder.status<8}">
                <img src="../images/orderinfo/orderinfo_img6_2.png" alt=""/></dt>
              ...
              <dl>
                ...
                <c:if test="${ajiaOrderVo.ajiaOrder.status>=4 && ajiaOrderVo.ajiaOrder.status<8}">
                  <img src="../images/orderinfo/orderinfo_img3_1.png" alt=""/>
              ...
              <dl>
                <dt class="point">
                <c:if test="${ajiaOrderVo.ajiaOrder.status<6 || ajiaOrderVo.ajiaOrder.status==8}">
                <img src="../images/orderinfo/orderinfo_img6.png" alt=""/></dt>
                </c:if>
                <c:if test="${ajiaOrderVo.ajiaOrder.status>=6 && ajiaOrderVo.ajiaOrder.status<8}">
                <img src="../images/orderinfo/orderinfo_img6_2.png" alt=""/></dt>
              ...
              <dl>
                ...
                <c:if test="${ajiaOrderVo.ajiaOrder.status>=6 && ajiaOrderVo.ajiaOrder.status<8}">
                  <img src="../images/orderinfo/orderinfo_img4_1.png" alt=""/>
              ...
              <dl>
                <dt class="point">
                <c:if test="${ajiaOrderVo.ajiaOrder.status<7 || ajiaOrderVo.ajiaOrder.status==8}">
                <img src="../images/orderinfo/orderinfo_img6.png" alt=""/></dt>
                </c:if>
                <c:if test="${ajiaOrderVo.ajiaOrder.status>=7 && ajiaOrderVo.ajiaOrder.status<8}">
                <img src="../images/orderinfo/orderinfo_img6_2.png" alt=""/></dt>
