...
<!--订单确认-->
<form 
action="http://payment.ajstore.com:82/yibao/paymentSend.html" method="post" id="pay_form">
    <input type="hidden" name="orderId" value="${ajiaOrder.orderId}"> 
    <div id="container" class="clearfix" >
        <!-- 支付订单信息-->
        <div class="pay_info">
            <b>支付金额：<i>${ajiaOrder.payment}元</i></b><input type="hidden" name="payment" value="0.01"/>
