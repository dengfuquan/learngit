	...
	<div id="container">
		<div id="cover" class="rt">
			<form id="login-form" method="post" name="form1">
				<div class="txt">
					<p>
						登录学子商城 <span> <a href="register.html">新用户注册</a>
						</span>
					</p>
					<div class="text">
					...
					<div class="text">
						<input type="password" id="password" placeholder="请输入您的密码"
							name="password" required minlength="6" maxlength="15"> <span><img
			...
			$.ajax({
				...
				success : function(txt, msg, xhr) {
					if (txt.status == 200) { //登录成功
						...
						$('#showResult').html('登录失败！错误消息为：' + txt.msg);
					}
				}
			});
		});
